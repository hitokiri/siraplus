...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cliente.grupo'
        db.add_column(u'master_cliente', 'grupo',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=10),
                      keep_default=False)

        # Adding field 'MasterDPPA.grupo'
        db.add_column(u'master_masterdppa', 'grupo',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cliente.grupo'
        db.delete_column(u'master_cliente', 'grupo')

        # Deleting field 'MasterDPPA.grupo'
        db.delete_column(u'master_masterdppa', 'grupo')
    ...
    models = {
        ...
        u'master.masterdppa': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fecha_entrega': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 11, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'grupo': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
