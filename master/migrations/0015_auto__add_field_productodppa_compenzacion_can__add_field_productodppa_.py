...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductoDPPA.compenzacion_can'
        db.add_column(u'master_productodppa', 'compenzacion_can',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'ProductoDPPA.compenzacion_tipo'
        db.add_column(u'master_productodppa', 'compenzacion_tipo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductoDPPA.compenzacion_can'
        db.delete_column(u'master_productodppa', 'compenzacion_can')

        # Deleting field 'ProductoDPPA.compenzacion_tipo'
        db.delete_column(u'master_productodppa', 'compenzacion_tipo')
    ...
    models = {
        ...
        u'master.masterdppa': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fecha_entrega': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'grupo': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
