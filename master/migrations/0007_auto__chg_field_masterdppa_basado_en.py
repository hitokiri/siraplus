...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'MasterDPPA.basado_en' to match new field type.
        db.rename_column(u'master_masterdppa', 'basado_en', 'basado_en_id')
        # Changing field 'MasterDPPA.basado_en'
        db.alter_column(u'master_masterdppa', 'basado_en_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['master.MasterDPPA']))
        # Adding index on 'MasterDPPA', fields ['basado_en']
        db.create_index(u'master_masterdppa', ['basado_en_id'])


    def backwards(self, orm):
        # Removing index on 'MasterDPPA', fields ['basado_en']
        db.delete_index(u'master_masterdppa', ['basado_en_id'])


        # Renaming column for 'MasterDPPA.basado_en' to match new field type.
        db.rename_column(u'master_masterdppa', 'basado_en_id', 'basado_en')
        # Changing field 'MasterDPPA.basado_en'
    ...
    models = {
        ...
        u'master.masterdppa': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fecha_entrega': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 22, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
