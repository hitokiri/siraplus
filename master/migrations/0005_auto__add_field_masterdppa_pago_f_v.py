...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MasterDPPA.pago_f_v'
        db.add_column(u'master_masterdppa', 'pago_f_v',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MasterDPPA.pago_f_v'
        db.delete_column(u'master_masterdppa', 'pago_f_v')
    ...
    models = {
        ...
        u'master.masterdppa': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fecha_entrega': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 18, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
