...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MasterDPPA.tiene_modificaciones'
        db.add_column(u'master_masterdppa', 'tiene_modificaciones',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MasterDPPA.es_modificacion_de'
        db.add_column(u'master_masterdppa', 'es_modificacion_de',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['master.MasterDPPA'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MasterDPPA.tiene_modificaciones'
        db.delete_column(u'master_masterdppa', 'tiene_modificaciones')

        # Deleting field 'MasterDPPA.es_modificacion_de'
        db.delete_column(u'master_masterdppa', 'es_modificacion_de_id')
    ...
    models = {
        ...
        u'master.masterdppa': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fecha_entrega': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
