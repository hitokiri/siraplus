...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductoDPPA.cambios'
        db.add_column(u'master_productodppa', 'cambios',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProductoDPPA.cambios'
        db.delete_column(u'master_productodppa', 'cambios')
    ...
    models = {
        ...
        u'master.masterdppa': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fecha_entrega': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'grupo': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
