...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cliente.fecha_naciemiento'
        db.add_column(u'master_cliente', 'fecha_naciemiento',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 28, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cliente.fecha_naciemiento'
        db.delete_column(u'master_cliente', 'fecha_naciemiento')
