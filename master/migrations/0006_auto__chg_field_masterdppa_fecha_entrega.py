...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MasterDPPA.fecha_entrega'
        db.alter_column(u'master_masterdppa', 'fecha_entrega', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'MasterDPPA.fecha_entrega'
        db.alter_column(u'master_masterdppa', 'fecha_entrega', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'master.masterdppa': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fecha_entrega': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 19, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
