...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MasterDPPA.de_menos'
        db.alter_column(u'master_masterdppa', 'de_menos', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'MasterDPPA.de_mas'
        db.alter_column(u'master_masterdppa', 'de_mas', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'MasterDPPA.de_menos'
        db.alter_column(u'master_masterdppa', 'de_menos', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'MasterDPPA.de_mas'
        db.alter_column(u'master_masterdppa', 'de_mas', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))
    ...
    models = {
        ...
        u'master.masterdppa': {
            ...
            'de_mas': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
            'de_menos': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fecha_entrega': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'grupo': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
